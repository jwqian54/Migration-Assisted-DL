...
from model.UNet import UNetV11
...
model_type = f'2ndStage_MSELoss_2DV13_Geo_UNetV11_Checked_Xavier_Batch32_ssim2_{num_test+num_train}_ConstantLR'
...
model = UNetV11(in_channels=1,out_channels=1)
...
model_load = UNetV11(in_channels=1,out_channels=1)
is_cuda = check_cuda()
if is_cuda:
    model_load.cuda()
