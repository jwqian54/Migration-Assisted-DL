import os
import sys
# 将项目根 D:\tgrs_open 加入路径，以便直接运行本脚本时能找到 model/loaddata 等包
...
from model.DPENet import DPENet
...
from loaddata.matload import load_2ndStage_decayvalue
from loaddata.matload import load_1stStage_value
...
model_type = f'2PerEst_DPENet_Batch{batchsize}_rawwotz_Aug{Data_Augmentation}_Regression{Regression}_{num_test+num_train}_2DV13_fold{ii_fold}'
...
model = DPENet(1,channels,atrous_rates)
...
model_load = DPENet(1,channels,atrous_rates)
