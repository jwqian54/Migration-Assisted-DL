...
matfilename_migration_train = "Input_Migration"
matfilename_migration_test = "Input_Migration_TestDataset"

migration_prefix = "ssim2_twodefect_"
migration_suffix = "v"
index_digit = 5

matfilename_geo = "Output_GeoMap"
geo_prefix = "defect_geo_"
geo_suffix = ""
...
model_type = f'2ndStage_MSELoss_2DV13_Geo_SRNet_Checked_Xavier_Batch32_ssim2_{num_test+num_train}_ConstantLR'
...
model = SRNet(in_channels=1,out_channels=1)
...
model_load = SRNet(in_channels=1,out_channels=1)
is_cuda = check_cuda()
if is_cuda:
    model_load.cuda()
